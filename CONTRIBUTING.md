...
documentation, testing, and filing issues.** Please read it carefully to help make
...
The preferred workflow for contributing to riskpy is to fork the
[main repository](https://github.com/Falconwatch/riskpy) on
GitHub, clone, and develop on a branch. Steps:

1. Fork the [project repository](https://github.com/Falconwatch/riskpy)
   by clicking on the 'Fork' button near the top right of the page. This creates
   a copy of the code under your GitHub user account. For more details on
   how to fork a repository see [this guide](https://help.github.com/articles/fork-a-repo/).

2. Clone your fork of the riskpy repo from your GitHub account to your local disk:

   ```bash
   $ git clone git@github.com:YourLogin/riskpy.git
   $ cd riskpy
   ```
...
-  Verify that your issue is not being currently addressed by other
   [issues](https://github.com/Falconwatch/riskpy/issues?q=)
   or [pull requests](https://github.com/Falconwatch/riskpy/pulls?q=).
...
A great way to start contributing to riskpy is to pick an item from the
list of
[good first issues](https://github.com/Falconwatch/riskpy/labels/good%20first%20issue). If
you have already contributed to scikit-learn look at
[Easy issues](https://github.com/Falconwatch/riskpy/labels/Easy)
